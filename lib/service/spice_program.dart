...
class SpiceProgram {
  ...
  static Pubkey programId = Pubkey.fromBase58("5Z6fCEshc14qcy5y3c2xk5ni4Vj2rjBN5eGoTcuBoW9x");
  ...
  static Future<Transaction> increaseLiquidity(
    ...
    data.addAll(Uint8List(8)..buffer.asByteData().setInt32(0, amount, Endian.host));
  ...
  static Future<Transaction> swap(
    ...
    data.addAll(Uint8List(8)
      ..buffer.asByteData().setInt32(0, inputAmount, Endian.host));
    data.addAll(Uint8List(8)
      ..buffer.asByteData().setInt32(0, minOutputAmount, Endian.host));
